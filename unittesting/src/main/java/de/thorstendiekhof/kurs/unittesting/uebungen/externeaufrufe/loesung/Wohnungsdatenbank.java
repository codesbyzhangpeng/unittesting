 ...
 * abläuft.
 */
public class Wohnungsdatenbank implements Datenbestand{
    ...
    private String[] beschreibungen = {"Super Lage","Altbau aber trotzdem gut.",
                    ...
                    "Genial einfach.", "Schöner Blick.", "Zentrumsnah und ruhig",
                    "Vorne Einkaufsstraße, hinten Wald", "Dunkles Kellerloch."};
